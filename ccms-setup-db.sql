...
(48, 'Nederlands (Dutch)', 0, 'nl', 0, 'ltr', ''),
(49, 'Norwegian (Bokmal)', 0, 'nb-no', 0, 'ltr', ''),
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COMMENT='Records saved here contain details related to possible session high-jacking attempts.';
