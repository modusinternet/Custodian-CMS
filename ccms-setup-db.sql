...
--
-- Host: localhost
-- Generation Time: Sep 13, 2017 at 06:41 PM
...
INSERT INTO `ccms_ins_db` (`id`, `status`, `access`, `grp`, `name`, `de`, `en`, `es`, `fr`, `ms`, `nb-no`, `pt`, `ar`, `bn`, `ru`, `he`, `hi`, `ja`, `zh-cn`, `zh-tw`) VALUES
(1, 1, 0, 'index', 'para1', 'Der schnelle braune Fuchs springt über den faulen Hund.', 'The quick brown fox jumps over the lazy dog.', 'El rápido zorro marrón salta sobre el perro perezoso.', 'Le brun rapide le renard saute sur le chien paresseux.', '', '', '', 'ويقفز الثعلب البني السريع فوق الكلب الكسول.', '', '', '', '', '速い茶色のキツネは怠け者の犬を跳び越えます。', '那只敏捷的棕毛狐狸跃过那只懒狗。', ''),
