...
--
-- Host: localhost:3306
-- Generation Time: Oct 18, 2021 at 09:46 PM
...
(10, 1, 'Content-Security-Policy', 'base-uri \'none\'; connect-src \'self\' https: *.cloudfront.net *.doubleclick.net *.google.com *.googleapis.com *.googletagmanager.com *.google-analytics.com *.gstatic.com; form-action \'self\'; frame-ancestors \'self\'; img-src \'self\' data: https: *.cloudfront.net *.doubleclick.net *.gstatic.com *.google-analytics.com *.googleapis.com *.googleusercontent.com *.googletagmanager.com *.google.com *.gravatar.com; object-src \'none\'; worker-src \'self\'; script-src \'nonce-{NONCE}\' \'strict-dynamic\' \'unsafe-inline\'{UNSAFE-EVAL} https:; script-src-attr \'nonce-{NONCE}\' \'strict-dynamic\';', '');
...
(64, 'المملكة العربية السعودية (Saudi Arabia)', 0, 'ar-sa', 0, 'rtl', 'ar');
