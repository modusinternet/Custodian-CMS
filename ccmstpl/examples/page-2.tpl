{CCMS_DB_PRELOAD:page,page-2}<!DOCTYPE html>
	...
	<head>
		<meta charset="utf-8">
		<title>Custodian CMS v0.3 - {CCMS_DB:page,title}2</title>
	...
	<body>
		...
		<ul>
			<li><a class="tapTarget" href="/en/examples/page-2.html" onclick="delLngCookie()">English</a></li>
			<li><a class="tapTarget" href="/fr/examples/page-2.html" onclick="delLngCookie()">Français</a></li>
			<li><a class="tapTarget" href="/de/examples/page-2.html" onclick="delLngCookie()">German (Standard)</a></li>
			<li><a class="tapTarget" href="/ja/examples/page-2.html" onclick="delLngCookie()">日本語 (Japanese)</a></li>
			<li><a class="tapTarget" href="/zh-cn/examples/page-2.html" onclick="delLngCookie()">简体中文(Simplified Chinese)</a></li>
		</ul>
		<p>
		...
		<h2>{CCMS_DB:page,page-num}2</h2>
		<p>
			{CCMS_DB:page-2,para1}
		</p>
