<? ob_start("ob_gzhandler"); require_once $_SERVER["DOCUMENT_ROOT"] . "/ccmspre/config.php"; header("Content-Type:text/css;"); ?>
...
================================================== */
	...
	h3 { font-size: 28px; line-height: 34px; margin: 40px 0px 8px 0px; }
...
/* Links
================================================== */
	a, a:visited { border:0 none; color: #ec7f27; text-decoration: none; outline: 0; }
	a:hover, a:focus { color: #ec7f27; border-bottom: 1px dotted #ec7f27; }
