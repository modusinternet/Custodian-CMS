...
<html lang="{CCMS_LIB:_default.php;FUNC:ccms_lng}">
	...
	<body>
		...
		<div style="float:left; width:300px;">
			...
			<p style="color:red;"><?=htmlspecialchars($_SERVER["REQUEST_URI"]);?> internal server error.  A generic error message, given when no more specific message is suitable.</p>
