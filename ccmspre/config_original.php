...
// e.g.:
// $CFG["COOKIE_EXPIRE"] = 182; // Half a year.
// $CFG["COOKIE_EXPIRE"] = 365; // One full year.
$CFG["COOKIE_EXPIRE"] = 365;

// Admin ID COOKIE expire time.  Set in number of minutes.
// e.g.:
// $CFG["COOKIE_EXPIRE_ADMIN"] = 20; // Just 20 minutes.
// $CFG["COOKIE_EXPIRE_ADMIN"] = 120; // Two hours.
$CFG["COOKIE_EXPIRE_ADMIN"] = 120;
