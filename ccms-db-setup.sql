...
--
-- Host: localhost:3306
-- Generation Time: Oct 14, 2016 at 03:12 PM
...
(1, 1, 0, 'index', 'para1', 'Der schnelle braune Fuchs springt über den faulen Hund.', 'The quick brown fox jumps over the lazy dog.', '', 'Le brun rapide le renard saute sur le chien paresseux.', '', '', 'ويقفز الثعلب البني السريع فوق الكلب الكسول.', '', '', '', 'तेज, भूरी लोमडी आलसी कुत्ते के उपर कूद गई।', '速い茶色のキツネは怠け者の犬を跳び越えます。', '那 只 咖 啡 色 狐 狸 跳 过 那 只 懒 惰 的 狗。', ''),
(2, 1, 0, 'index', 'para2', 'Wenn Zombies ankommen, schnell Richter Pat faxen.', 'When zombies arrive, quickly fax judge Pat.', '', 'Quand les zombies arrivent, faxent rapidement le juge Pat.', '', '', '', '', '', 'כאשר זומבים מגיעים, במהירות פקס לשפוט פט.', 'जब मुदित आ, भूरी लोमडी आलसी कुत्ते के उते है, जल्दी से पैट न्यायाधीश फैक्स।', 'ゾンビが到着するとき、速くパット裁判官にファクスで送ってください。', '当 僵 尸 到 达，它 很 快 地 传 真 给 法 官 Pat。', ''),
...
(55, '简体中国 (Chinese Simplified)', 1, 'zh-cn', 0, 'ltr', ''),
(56, '中國傳統 (Chinese Traditional)', 0, 'zh-tw', 0, '', 'zh-cn'),
