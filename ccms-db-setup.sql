...
--
-- Host: localhost
-- Generation Time: Jan 01, 2017 at 09:37 PM
...
(48, 'Norwegian (Bokmal)', 0, 'nb-no', 0, 'ltr', ''),
(49, 'Português (Portuguese)', 1, 'pt', 0, 'ltr', ''),
(50, 'العربية (Arabic)', 1, 'ar', 0, 'rtl', ''),
(51, 'বাঙ্গালী (Bengali)', 1, 'bn', 0, 'ltr', ''),
(52, 'Pусский (Russian)', 1, 'ru', 0, 'ltr', ''),
(53, 'हिन्दी (Hindi)', 1, 'hi', 0, 'ltr', ''),
(54, '日本語 (Japanese)', 1, 'ja', 0, 'ltr', ''),
(55, '中国 (Chinese)', 0, 'zh', 0, '', 'zh-cn'),
(56, '简体中国 (Simplified Chinese)', 1, 'zh-cn', 0, 'ltr', ''),
(57, '中國傳統 (Traditional Chinese)', 0, 'zh-tw', 0, '', 'zh-cn'),
(58, 'עברית (Hebrew)', 1, 'he', 0, 'rtl', '');
