...
(1, 1, 0, 'index', 'para1', 'Der schnelle braune Fuchs springt über den faulen Hund.', 'The quick brown fox jumps over the lazy dog.', 'El rápido zorro marrón salta sobre el perro perezoso.', 'Le brun rapide le renard saute sur le chien paresseux.', '', '', 'ويقفز الثعلب البني السريع فوق الكلب الكسول.', '', '', 'The quick brown fox jumps over the lazy dog.  sadf s', '', '速い茶色のキツネは怠け者の犬を跳び越えます。', '那只敏捷的棕毛狐狸跃过那只懒狗。', ''),
(2, 1, 0, 'index', 'para2', 'Wenn Zombies ankommen, schnell Richter Pat faxen.', 'When zombies arrive, quickly fax judge Pat.', 'Cuando llegan los zombis, de forma rápida Fax juzgar Pat.', 'Quand les zombies arrivent, faxent rapidement le juge Pat.', '', '', '', '', '', 'כאשר זומבים מגיעים, במהירו', '', 'ゾンビが到着するとき、速くパット裁判官にファクスで送ってください。', '僵尸到达时,快速传真法官英保通™技术。', ''),
...
(16, 1, 0, 'all', 'cookie-button', 'Fortsetzen', 'Continue', '', 'Continuer', '', '', 'استمر', '', '', 'לְהַמשִׁיך', 'जारी रहना', '持続する', '继续', ''),
(17, 1, 0, 'all', 'cookie-text', 'Diese Website verwendet Cookies, um die Spracheinstellungen zu verwalten und sicherzustellen, dass Sie beim Besuch unserer Website die bestmögliche Erfahrung haben.', 'This website uses cookies to help manage language settings and ensure you have the best possible experience while visiting our site.', '', 'Ce site Web utilise des cookies pour vous aider à gérer les paramètres linguistiques et vous assurer d\'avoir la meilleure expérience possible tout en visitant notre site.', '', '', 'هذا الموقع يستخدم الكوكيز للمساعدة في إدارة إعدادات اللغة وضمان أن يكون لديك أفضل تجربة ممكنة أثناء زيارة موقعنا.', '', '', 'אתר זה משתמש בעוגיות כדי לעזור לנהל את גדרות שפה לוודא שיש לך את החוויה הטובה ביותר האפשרית במהלך ביקור באתר שלנו.', 'इस वेबसाइट कुकीज़ का उपयोग करता भाषा सेटिंग्स का प्रबंधन और सुनिश्चित करें कि आप सबसे अच्छा संभव अनुभव है हमारी साइट पर जाकर जबकि करने के लिए।', 'このウェブサイトでは、クッキーを使用して言語設定を管理し、弊社のサイトを訪れている間に最高のエクスペリエンスを確保しています。', '本网站使用cookies来帮助管理语言设置，并确保您在访问我们的网站时拥有最好的体验。', '');
