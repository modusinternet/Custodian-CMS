...
} elseif($CLEAN["ccms_pass_reset_part_1"] == "1") {
...
} elseif($CLEAN["ccms_pass_reset_part_2"] == "1") {
...
} elseif($CLEAN["ccms_pass_reset_part_2"] == "2") {
...
<?php if($CLEAN["ccms_pass_reset_part_2"] != "1"): ?>
