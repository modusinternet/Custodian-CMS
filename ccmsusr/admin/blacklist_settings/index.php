...
<html id="no-fouc" lang="{CCMS_LIB:_default.php;FUNC:ccms_lng}" style="opacity: 0;">
	<head>
		<meta charset="utf-8">
		<title>Blacklist Settings</title>
	...
	<body>
		<div id="wrapper">
			...
			<div id="page-wrapper">
				<div class="row">
					<div class="col-md-12">
						<h1 class="page-header">Blacklist Settings</h1>
			...
			function loadJSResources() {
				loadFirst("//ajax.googleapis.com/ajax/libs/jquery/2.2.0/jquery.min.js", function(){ // JQuery is loaded
					loadFirst("//maxcdn.bootstrapcdn.com/bootstrap/3.3.6/js/bootstrap.min.js", function(){ // Bootstrap is loaded
						loadFirst("//cdnjs.cloudflare.com/ajax/libs/metisMenu/2.4.0/metisMenu.min.js", function(){ // MetisMenu JavaScript is loaded
